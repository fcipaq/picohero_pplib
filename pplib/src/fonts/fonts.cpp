...
/* ======================== definitions ========================= */
typedef enum {
  FONT_HEADER_FNT_WIDTH  = 2,  /**< @brief Offset to font width. */
  FONT_HEADER_FNT_HEIGHT = 3,  /**< @brief Offset to font height. */
  FONT_HEADER_FRST_CHAR  = 5,  /**< @brief Offset to first character. */
  FONT_HEADER_LST_CHAR   = 6,  /**< @brief Offset to last character. */
  FONT_HEADER_CHAR_WIDTH = 7,  /**< @brief Offset to character width area. */
} font_header_ofs_t ; 
